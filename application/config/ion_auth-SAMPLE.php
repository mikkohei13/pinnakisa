...
*/
$config['tables']['users']           = 'kisa_users';
$config['tables']['groups']          = 'kisa_groups';
$config['tables']['users_groups']    = 'kisa_users_groups';
$config['tables']['login_attempts']  = 'kisa_login_attempts';
 ...
 */
$config['site_title']                 = "Pinnakisapalvelu";       // Site Title, example.com
$config['admin_email']                = ""; 				// Admin Email, admin@example.com // FILL THIS
$config['default_group']              = 'users';           		// Default group, use name
$config['admin_group']                = 'admin';             // Default administrators group, use name
$config['identity']                   = 'email';             // A database column which is used to login with
$config['min_password_length']        = 8;                   // Minimum Required Length of Password
$config['max_password_length']        = 50;                  // Maximum Allowed Length of Password
...
$config['forgot_password_expiration'] = 86400000;                   // The number of milliseconds after which a forgot password request will expire. If set to 0, forgot password requests will not expire.
